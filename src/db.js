...
try {
    ...
    if (!existingCols.includes('luckyNewApiKey')) {
        db.prepare("ALTER TABLE users ADD COLUMN luckyNewApiKey TEXT").run();
        logger.info('[DB] Kolom luckyNewApiKey ditambahkan ke tabel users.');
    }
} catch (e) {
...
function saveUser(userId, data) {
    ...
    const allowedKeys = new Set([
        ...
        'staticPassword', 'reportFormat', 'tmailBaseUrl', 'tmailApiKey', 'tmailDomains', 'luckMailApiKey', 'luckMailDomains', 'luckyNewApiKey'
    ]);
